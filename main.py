...
parser.add_argument("-c", "--channelNum", type=int, default=16,
...
loss, image = featurevis.visualize_filter(image, model, layer_name, channel_num, 1500, 0.7, False, True, True)
